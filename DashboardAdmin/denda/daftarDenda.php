...
<html lang="en">
  ...
  <footer class="fixed-bottom shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Kelompok 2 </span> © 2023</p>
      <p class="mt-2">versi 1.0</p>
      </div>
    </footer>
     <!--====== FOOTER PART START ======-->
     <footer class="fixed-bottom shadow-lg bg-subtle bg-body-secondary text-dark p-2">
        <div class="container">
          <div class="row">
